...
hanya dijalankan ulang bila standarnya berubah. Lihat docs/04-spesifikasi-antropometri.md.
        ...
        json.dumps(
            {
                ...
                "catatan": "Nilai diambil apa adanya dari berkas sumber, tanpa koreksi. Lihat OI-05 di docs/99-open-issues.md.",
                "baris": baris,
            },
            ensure_ascii=False,
            indent=1,
